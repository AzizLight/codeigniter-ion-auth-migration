...
class Migration_Create_ion_auth extends CI_Migration {
    ...
    private $password_length_constraint = 40;
    private $password = '59beecdf7fc966e2f17fd8f65a4a9aeb09d4a3d4';
    ...
    private function use_config()
    {
        ...
        if ($this->use_config)
        {
            ...
            $this->password_length_constraint = ($this->config->item('hash_method', 'ion_auth') === 'bcrypt') ? 80 : 40;
            $this->password = ($this->config->item('hash_method', 'ion_auth') === 'bcrypt') ? '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36' : '59beecdf7fc966e2f17fd8f65a4a9aeb09d4a3d4';
        }
    ...
    function up()
    {
        ...
        if (!$this->db->table_exists($this->users))
        {
            ...
            $this->dbforge->add_field(array(
                ...
                'password' => array('type' => 'VARCHAR', 'constraint' => $this->password_length_constraint, 'null' => FALSE),
